...
//
//------------------------------------------------------------------------------
void CHS2T::stepSafetyDevices(const double& t, const double& dt)
{
    ...
    for (size_t cab_idx : {CAB1, CAB2})
    {
        ...
        safety_device[cab_idx]->setRBstate(rb[cab_idx][RB1].getState());
        ...
        safety_device[cab_idx]->setShuntingModeState(shunting_mode_switcher[cab_idx].getState());
